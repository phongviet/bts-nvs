...
- **LPIPS backbone: VGG (near-certain, 2026-07-09).** LB LPIPS ≈ 0.27 vs local alex ≈ 0.13 (~2×, classic vgg-vs-alex gap), and the exp011 op's big alex-LPIPS gain (−0.024) didn't transfer (LB −0.0017) while its PSNR/SSIM costs transferred ~exactly. **Switch local decision scoring to `--lpips-net vgg`.** Alex-scored decisions to sanity-check under vgg: exp011 (already refuted by LB), others were won on all-three-metrics so safe.
